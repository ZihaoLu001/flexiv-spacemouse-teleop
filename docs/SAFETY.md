...
The bridge clamps commands and zeroes stale input. It does not enforce lab
workspace boundaries, human detection, task-level constraints, or force limits.
Those remain the responsibility of the robot controller, lab procedures, and
operator.
